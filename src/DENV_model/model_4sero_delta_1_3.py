...
class JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3(JumpProcess):
    """
    ...
    parameters = ['alpha','b', 'd', 'beta_0', 'sigma', 'gamma', 'psi', 'rho', 'delta_1', 'delta_3', 'sf'] 
    ...
    def compute_rates(t, 
        ...
        serotypes = JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.serotypes
        
        states_list = JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.states_list
        
        state_name_to_idx = JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.state_name_to_idx
        
        infectious_states_by_sero = JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.infectious_states_by_sero
        
        primary_idx_by_sero = JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.primary_idx_by_sero
...
JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.infectious_states_by_sero = {
    sero: [i for i, state in enumerate(JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.states_list)
           if state.startswith("I") and state.endswith(sero)]
    for sero in ["1", "2", "3", "4"]
}
JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.primary_idx_by_sero = {
    sero: JumpProcess_SEIR4_beta_by_Temp_sf_BirthDeath_reported_d_1_3.state_name_to_idx[f"I{sero}"]
    for sero in ["1", "2", "3", "4"]
}