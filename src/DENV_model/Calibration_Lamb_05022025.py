...
# Variables
samples_path='optimization_Lamb/'
fig_path='optimization_Lamb/'
identifier = 'Lambrechts_rverstra' # Give any output of this script an ID
...
common_dates = counts_weekly.index.intersection(scaling_factors_weekly['lambrechts'].index)
...
params["sf"] = params["sf"].to_frame() # instead of a Series
