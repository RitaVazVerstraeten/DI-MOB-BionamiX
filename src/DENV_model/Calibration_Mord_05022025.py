...
# Variables
samples_path='optimization_Mord/'
fig_path='optimization_Mord/'
identifier = 'Mordecai_rverstra' # Give any output of this script an ID
...
common_dates = counts_weekly.index.intersection(scaling_factors_weekly['mordecai_aeg'].index)
