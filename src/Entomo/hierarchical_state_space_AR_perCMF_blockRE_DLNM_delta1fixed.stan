...
// Variant: delta1 is fixed (passed as data) rather than estimated.
//   Pass delta1 = 0 from R to disable reactive detection enhancement entirely,
//   or any positive value to fix it at a known/assumed level.
...
data {
  ...
  real<lower=0> delta1;          // fixed reactive detection boost; pass 0 to disable
}
