// Block random-effects model with DLNM cross-basis environmental predictors.
// Replaces X_lag_flat / K / Lp1 / w[K,Lp1] with a pre-built cross-basis
// matrix X_cb[N, P_cb] and coefficient vector w_cb[P_cb].
